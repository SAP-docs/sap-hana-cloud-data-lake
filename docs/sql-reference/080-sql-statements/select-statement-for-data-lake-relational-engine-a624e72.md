 ...
 :   Retrieves rows and views specified in the *<object-list\>*.
    ...
    <object-list> ::=
       [ { [/pandoc/div/div/horizontalrule/definitionlist/dlentry/dd/codeblock/span/varname
         ...
         {"varname"}) <schema-name> (varname] }.] <object-name> [,...]
    ```
...
[SELECT Statement for Data Lake Relational Engine (SAP HANA DB-Managed)](https://help.sap.com/viewer/a898e08b84f21015969fa437e89860c8/2023_1_QRC/en-US/7123f8b4e1f14a8f9efd257794202198.html "Retrieves information from the database.") :arrow_upper_right:
