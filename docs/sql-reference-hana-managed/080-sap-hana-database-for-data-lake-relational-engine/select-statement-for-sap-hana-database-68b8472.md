...
<subquery> ::= [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <select_clause> (varname] [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <from_clause> (varname] [ [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <where_clause> (varname] ]
 [ [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <group_by_clause> (varname] ]
 [ [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <having_clause> (varname] ] 
 [ [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <set_operator> (varname] <subquery> [ {, [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <set_operator> (varname] <subquery> }... ] ]
 [ [/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <order_by_clause> (varname][/pandoc/div/div/horizontalrule/codeblock/link/varname
     {"varname"}) <limit_clause> (varname] ]  
```
 ...
 :   Specifies inputs such as tables, views, and subqueries to be used as the data source for the SELECT statement.
    ...
    <table_expression> ::= 
     ...
     | [/pandoc/div/div/horizontalrule/definitionlist/dlentry/dd/codeblock/span/varname
         {"varname"}) <collection_derived_table> (varname]
     | <function_reference>
     | :<table_variable>
