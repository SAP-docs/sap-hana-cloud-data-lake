...
...FROM <table-expression><table-expression> ::=
   ...
   | [/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_view_name> (varname]
   | <procedure-name>
...
[/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_table_name> (varname] ::=
   [ <userid>.] [/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_table_name> (varname] ]
   [ [ AS ] <correlation-name> ]
...
[/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_view_name> (varname] ::=
   [ <userid>.][/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_view_name> (varname] [ [ AS ] <correlation-name> ]
```

```
<procedure-name> ::=
   [  [/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <relational_container_schema_name> (varname], ] <procedure-name> ([ <parameter>, ...])
...
<contains-expression> ::=
   { [/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_table_name> (varname]  | [/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_view_name> (varname] } CONTAINS 
...
<rowset-schema> ::=
   <column-schema-list>
	   | TABLE [[/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <relational_container_schema_name> (varname].][/pandoc/div/div/horizontalrule/codeblock/span/varname
     {"varname"}) <data_lake_table_name> (varname] [ ( <column-list> ) ]
```
